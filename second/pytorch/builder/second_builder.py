...
def build(
    ...
    net = VoxelNet(
        ...
        rpn_aggregator_n_filters=list(aggregator_n_filters),
        rpn_projector_n_filters=list(projector_n_filters),
        rpn_predictor_n_filters=list(predictor_n_filters),
